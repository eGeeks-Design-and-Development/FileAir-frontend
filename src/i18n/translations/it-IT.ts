export default {
  ...
  "home.bullet.a.description": "Configura File Air sul tuo server.",
  ...
  "admin.config.config-file-warning.description": "Poiché hai configurato File Air tramite un file di configurazione, non ti è possibile modificare la configurazione dall'interfaccia utente.",
  ...
  "admin.config.general.app-url.description": "Su quale URL File Air è pubblicato",
  ...
  "admin.config.cache.redis-enabled.description": "Normalmente File Air mantiene la cache in memoria. Se si eseguono più istanze di File Air, è necessario abilitare il caching di Redis per condividere la cache tra le istanze.",
