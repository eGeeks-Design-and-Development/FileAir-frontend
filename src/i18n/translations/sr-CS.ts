export default {
  ...
  "home.bullet.a.description": "Hostujte File Air na svojoj mašini.",
  ...
  "admin.config.config-file-warning.description": "Pošto ste konfigurisali File Air pomoću konfiguracionog fajla, ne možete menjati konfiguraciju putem korisničkog interfejsa (UI).",
  ...
  "admin.config.general.app-url.description": "Na kojoj URL adresi je dostupan File Air",
  ...
  "admin.config.cache.redis-enabled.description": "File Air obično kešira informacije u memoriji. Ako pokrećete više instanci File Air-a, potrebno je da omogućite Redis keširanje kako bi se keš delio između instanci.",
