export default {
  ...
  "home.bullet.a.description": "Hospede o File Air em sua própria máquina.",
  ...
  "admin.config.config-file-warning.description": "Como você tem um File Air configurado com um arquivo de configuração, você não pode alterar a configuração através da UI.",
  ...
  "admin.config.general.app-url.description": "Em qual URL o File Air está disponível",
  ...
  "admin.config.cache.redis-enabled.description": "Normalmente informações de caches File Air na memória. Se você executar várias instâncias do File Air, você precisa habilitar o cache do Redis para compartilhar o cache entre as instâncias.",
