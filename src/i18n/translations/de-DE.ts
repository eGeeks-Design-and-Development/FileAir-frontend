export default {
  ...
  "home.bullet.a.description": "Betreibe File Air auf deinem eigenen Server.",
  ...
  "admin.config.config-file-warning.description": "Da File Air mit einer Konfigurationsdatei konfiguriert ist, kann die Konfiguration nicht über die Benutzeroberfläche geändert werden.",
  ...
  "admin.config.general.app-url.description": "Auf welcher URL File Air verfügbar ist",
  ...
  "admin.config.cache.redis-enabled.description": "Normally File Air caches information in memory. If you run multiple instances of File Air, you need to enable Redis caching to share the cache between the instances.",
