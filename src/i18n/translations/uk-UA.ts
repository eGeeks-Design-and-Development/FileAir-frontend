export default {
  ...
  "home.bullet.a.description": "File Air працює на вашій машині.",
  ...
  "admin.config.config-file-warning.description": "Оскільки у вас налаштовано File Air за допомогою конфігураційного файлу, ви не можете змінювати конфігурацію через інтерфейс користувача.",
  ...
  "admin.config.general.app-url.description": "Адреса, на якій доступний File Air",
