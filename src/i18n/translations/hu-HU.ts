export default {
  ...
  "home.bullet.a.description": "A File Air megosztót saját gépéről futtathatja.",
  ...
  "admin.config.general.app-url.description": "A File Air megosztáskezelőre mutató hivatkozás",
