export default {
  ...
  "home.bullet.a.description": "Hébergez File Air sur votre propre machine.",
  ...
  "admin.config.config-file-warning.description": "Puisque vous avez configuré File Air avec un fichier de configuration, vous ne pouvez pas modifier la configuration via l'interface utilisateur.",
  ...
  "admin.config.cache.redis-enabled.description": "Usuellement, File Air conserve les informations en mémoire vive. Si vous exécutez plusieurs instances de File Air, vous devez activer la mise en cache Redis pour partager le cache entre ces instances.",
