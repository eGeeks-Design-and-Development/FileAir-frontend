export default {
  ...
  "home.bullet.a.description": "Hosta File Air på din egen maskin.",
  ...
  "admin.config.config-file-warning.description": "Eftersom du har en konfigurerad File Air med en konfigurationsfil kan du inte ändra konfigurationen genom UI.",
  ...
  "admin.config.general.app-url.description": "På vilken URL File Air finns",
