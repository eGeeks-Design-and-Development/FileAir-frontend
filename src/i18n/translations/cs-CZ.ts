export default {
  ...
  "home.bullet.a.description": "Hostujte File Air na svém vlastním počítači.",
  ...
  "admin.config.config-file-warning.description": "Jelikož je File Air nastaven pomocí konfiguračního souboru, nemůžete změnit nastavení přes UI.",
  ...
  "admin.config.general.app-url.description": "Na kterém URL je File Air k dispozici",
