export default {
  ...
  "home.bullet.a.description": "Host File Air Share on your own machine.",
  ...
  "admin.config.config-file-warning.description":
    "As you have a configured File Air with a configuration file, you can't change the configuration through the UI.",
  ...
  "admin.config.general.app-url.description":
    "On which URL File Air is available",
  ...
  "admin.config.cache.redis-enabled.description":
    "Normally File Air caches information in memory. If you run multiple instances of File Air, you need to enable Redis caching to share the cache between the instances.",
