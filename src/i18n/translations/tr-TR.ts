export default {
  ...
  "home.bullet.a.description": "File Air'i kendi sunucunuzda barındırın.",
  ...
  "admin.config.config-file-warning.description": "File Air'i bir yapılandırma dosyası ile kurduğunuz için, yapılandırmayı arayüz üzerinden değiştiremezsiniz.",
  ...
  "admin.config.general.app-url.description": "File Air'in erişilebilir olduğu URL",
  ...
  "admin.config.cache.redis-enabled.description": "Normalde File Air bilgileri bellekte önbellekler. Birden fazla File Air örneği çalıştırıyorsanız, örnekler arasında önbelleği paylaşmak için Redis önbelleklemesini etkinleştirmeniz gerekir.",
