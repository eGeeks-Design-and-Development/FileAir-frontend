export default {
  ...
  "home.bullet.a.description": "Hosti File Air oma seadmes.",
  ...
  "admin.config.config-file-warning.description": "Kuna teil on konfigureeritud File Air konfiguratsioonifailiga, ei saa te muuta konfiguratsiooni kasutajaliidest kasutades.",
  ...
  "admin.config.general.app-url.description": "URL, mille kaudu File Air on kättesaadav",
